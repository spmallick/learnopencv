    ...
    def train(self):
        ...
        for step in pbar:
            ...
            if step in [i - 1 for i in cfg.eval_steps]:
                self.eval(step)
                print("\n=-----------------------------------------------")
                print("saved ply at: ", "iteration_{}.ply".format(step))
                self.save_ply(os.path.join(self.cfg.result_dir, "iteration_{}.ply".format(step)))
...
def main(local_rank: int, world_rank, world_size: int, cfg: Config):
    ...
    if cfg.ckpt is not None:
        ...
        print("\n=-----------------------------------------------")
        print("saved ply at: ", "iteration_{}.ply".format(step))
        runner.save_ply(os.path.join(cfg.result_dir, "iteration_{}.ply".format(step)))

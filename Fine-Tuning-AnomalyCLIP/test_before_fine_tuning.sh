...
for i in "${!depth[@]}";do
    ...
    ## train on the VisA dataset
        ...
        --data_path /home/shubham/Work/AnomalyCLIP/Thyroid_Dataset/tn3k --save_path /home/shubham/Work/AnomalyCLIP/results/singlescale \
...
for i in "${!depth[@]}";do
    ...
    ## train on the VisA dataset
        ...
        echo ${t_n_ctx}
        CUDA_VISIBLE_DEVICES=${device} python test.py --dataset thyroid \
        --data_path /home/shubham/Work/AnomalyCLIP/Thyroid_Dataset/tn3k --save_path /home/shubham/Work/AnomalyCLIP/results/singlescale_visa \
        --checkpoint_path ${save_dir}epoch_15.pth \
        --features_list 24 --image_size 518 --depth ${depth[i]} --n_ctx ${n_ctx[j]} --t_n_ctx ${t_n_ctx[0]}
    wait
    done

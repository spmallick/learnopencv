...
| Blog Post        | |
| ------------- |:-------------|
|[PyTorch for Beginners: Comparison of pre-trained models for Image Classification] () | [Code](https://github.com/spmallick/learnopencv/tree/master/Image-classification-pre-trained-models/Image_Classification_using_pre_trained_models.ipynb) |

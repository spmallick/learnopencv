...
segment(dlab, './images/bgremoval/white-car.png', show_orig=False)
segment(dlab, './images/bgremoval/black-car.png', show_orig=False)
segment(dlab, './images/bgremoval/blue-car.png', show_orig=False)
